...
if(localStorage.getItem('creatorMode') === null){localStorage.creatorMode = 'disabled'}
if(localStorage.getItem('creatorMode') != null && localStorage.getItem('creatorMode') === 'enabled'){setCreatorMode(!/enabled/.test(el('switch-create').className))}

if(localStorage.getItem('patchType') === null){localStorage.patchType = 'ips'}
if(localStorage.getItem('patchType') != null){el('select-patch-type').value = localStorage.getItem('patchType')}
document.getElementById('select-patch-type').addEventListener('change', function(){localStorage.patchType = this.value})
})
